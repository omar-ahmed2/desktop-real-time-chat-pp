      ...
      <div className="sidebar">
        ...
        <div className="user-profile">
          ...
          <div className="profile-info">
            <div className="profile-name">Sarah Parker</div>
      ...
      <main className="chat-main">
        <header className="chat-header">
          <div className="chat-header-info">
            <h2 className="chat-title">Design Team</h2>
            <span className="chat-subtitle">12 members</span>
          </div>
          <div className="chat-actions">
            ...
            <button className="action-button">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19 8H5C3.34 8 2 9.34 2 11V17H6V21H18V17H22V11C22 9.34 20.66 8 19 8ZM16 19H8V14H16V19ZM19 12C18.45 12 18 11.55 18 11C18 10.45 18.45 10 19 10C19.55 10 20 10.45 20 11C20 11.55 19.55 12 19 12ZM17 3H7V7H17V3Z" fill="currentColor"/>
              </svg>
            </button>
            <button className="action-button">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="chat-messages">
          ...
          <div className="message sent">
            ...
            <div className="message-content">
              <div className="message-bubble">
                Great work Sarah! The color scheme looks perfect 👍
              </div>
        ...
        <div className="chat-input">
          <form className="input-container" onSubmit={handleSend}>
            <div className="input-actions">
              ...
              <button type="button" className="input-button">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19 3H5C3.89 3 3 3.9 3 5V19C3 20.1 3.89 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM19 19H5V5H19V19ZM13.96 12.29L11.21 15.83L9.25 13.47L6.5 17H17.5L13.96 12.29Z" fill="currentColor"/>
                </svg>
              </button>
            </div>
            <textarea
